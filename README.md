...
- Added `ComprehendFullAccess` managed policy annotation, to allow a lambda access to [AWS Comprehend](https://aws.amazon.com/comprehend/) where applicable, eg. to do sentiment analysis on English text.
