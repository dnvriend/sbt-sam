...
package object serverless {
  final val SERVERLESS_PLUGIN_WORK_DIR = "serverless-plugin-work"
  final val CLOUDFORMATION_TEMPLATE_NAME_COGNITO = "cloudformation-template-cognito"
  final val CLOUDFORMATION_TEMPLATE_NAME_DYNAMODB = "cloudformation-template-dynamodb"
  final val SERVERLESS_PROJECT_BASE_URL: String = "SERVERLESS_PROJECT_BASE_URL"
  final val SERVERLESS_ID_TOKEN: String = "SERVERLESS_ID_TOKEN"
  ...
  def cognitoCloudFormationTemplateName(stage: String): String = {
    s"$CLOUDFORMATION_TEMPLATE_NAME_COGNITO-$stage.json"
  }

  def dynamoDbCloudFormationTemplateName(stage: String): String = {
    s"$CLOUDFORMATION_TEMPLATE_NAME_DYNAMODB-$stage.json"
  }
